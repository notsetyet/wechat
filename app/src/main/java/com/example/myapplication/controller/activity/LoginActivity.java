...
public class LoginActivity extends Activity {
            ...
            public void run() {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(LoginActivity.this, "注册失败"+e.getErrorCode(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void initView() {
        et_login_name = (EditText)findViewById(R.id.et_login_usr);
        et_login_pwd = (EditText)findViewById(R.id.et_login_pwd);
        bt_login_regist = (Button)findViewById(R.id.bt_login_register);
